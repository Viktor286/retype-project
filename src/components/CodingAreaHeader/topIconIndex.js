const topIconIndex = [
  'anchor-solid.svg',
  'canadian-maple-leaf-brands.svg',
  'cut-solid.svg',
  'play-circle-solid.svg',
  'snowflake-solid.svg',
  'angellist-brands.svg',
  'cannabis-solid.svg',
  'dharmachakra-solid.svg',
  'power-off-solid.svg',
  'space-shuttle-solid.svg',
  'ankh-solid.svg',
  'cat-solid.svg',
  'fist-raised-solid.svg',
  'python-brands.svg',
  'spider-solid.svg',
  'arrow-alt-circle-right-regular.svg',
  'child-solid.svg',
  'globe-africa-solid.svg',
  'question-circle-solid.svg',
  'utensils-solid.svg',
  'arrow-alt-circle-right-solid.svg',
  'cog-solid.svg',
  'globe-americas-solid.svg',
  'radiation-alt-solid.svg',
  'volleyball-ball-solid.svg',
  'atom-solid.svg',
  'compact-disc-solid.svg',
  'heart-solid.svg',
  'reddit-brands.svg',
  'wrench-solid.svg',
  'bahai-solid.svg',
...
export const defaultTopSvgIcon =
